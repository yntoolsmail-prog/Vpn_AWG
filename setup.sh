...
if [[ "$INSTALL_MODE" == "1" ]]; then
    pip3 install "python-telegram-bot[job-queue]>=20.0,<22" --break-system-packages > /dev/null 2>&1 || \
    pip3 install "python-telegram-bot[job-queue]>=20.0,<22" > /dev/null 2>&1
else
    pip3 install "python-telegram-bot[job-queue]>=20.0,<22" --break-system-packages || \
    pip3 install "python-telegram-bot[job-queue]>=20.0,<22"
fi
